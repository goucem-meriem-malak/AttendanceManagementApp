...
public class specialities extends AppCompatActivity {
    ...
    private void getSpecialities() {
        List<speciality> specialities = sessionManager.getSpecialities();
        LinearLayout specialityContainer = findViewById(R.id.list_specialities);
        ...
        for (int i = 0; i < specialities.size(); i++) {
            ...
            RelativeLayout space = specialityView.findViewById(R.id.space);
